  ...
  const sortedZones = [...filteredZones].sort((a, b) => {
    ...
    switch (sortBy) {
      ...
      case "freshness":
        ...
        break
      case "coinciding":
        aValue = a.coinciding_lower_zones?.length || 0
        bValue = b.coinciding_lower_zones?.length || 0
        break
      default:
        return 0
    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="coinciding">Coinciding Zones</option>
              </select>
            </div>
            ...
            <div className="overflow-auto max-h-[60vh]">
              <table className="min-w-full text-sm text-left text-gray-500">
                <thead className="bg-gray-50/80 backdrop-blur-sm sticky top-0">
                  <tr>
                    <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Zone ID</th>
                    <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Range</th>
                    <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Score</th>
                    <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Pattern</th>
                    <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Freshness</th>
                    <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase">Timestamp</th>
                  </tr>
                </thead>
                <tbody className="bg-white/60 backdrop-blur-sm divide-y divide-gray-200">
